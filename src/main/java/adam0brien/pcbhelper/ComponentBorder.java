...
public class ComponentBorder {
        ...
        public ComponentBorder(int root, int minX, int maxX, int minY, int maxY, int totalArea) {
            this.root = root;
            this.minX = minX;
            this.maxX = maxX;
            this.minY = minY;
        ...
        public static Comparator<ComponentBorder> AreaComparator = new Comparator<ComponentBorder>() {

            public int compare(ComponentBorder rN1, ComponentBorder rN2) {
